...
export default function IntegrationsPage() {
  ...
  const staticIntegrations = [
    ...
    {
      name: 'Slack',
      desc: 'Notifications + multi-channel (Future)',
      connected: false,
      system: false,
    },
    {
      name: 'Stripe',
      desc: 'Payment execution (Scaffold, disabled)',
      connected: false,
      system: false,
    },
  ]
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Connect your Google Account to grant Aether access to read/sync Gmail, schedule
                  Calendar events, and generate Google Meet links.
                </p>
                ...
                {isGoogleConnected ? (
                  <>
                    <Button
                      ...
                      onClick={() =>
                        handleConnectGoogle(
                          'https://www.googleapis.com/auth/gmail.send,https://www.googleapis.com/auth/gmail.modify,https://www.googleapis.com/auth/calendar',
                        )
                      }
                      disabled={actionLoading}
                    >
                      <RefreshCw className="mr-1.5 h-3.5 w-3.5" /> Reconnect Google / Grant Send
                      Scopes
                    </Button>
                    <Button
                      size="sm"
                  ...
                  <Button size="sm" onClick={() => handleConnectGoogle()} disabled={actionLoading}>
