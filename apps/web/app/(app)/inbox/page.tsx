import { Card, Button, Input, Badge } from '@aetheros/ui'
;('use client')
      ...
      <div className="space-y-4">
        {sidebarResults.length > 0 ? (
          <Card className="p-4 border-primary/40 shadow-md">
            ...
            <p className="text-xs text-muted-foreground font-medium mb-3">{sidebarTitle}</p>
          ...
          <Card className="p-4">
            ...
            <p className="text-xs text-muted-foreground">
              Enter commands in the top bar like <em>"give me last 4 hour email"</em> to show query
              results in this sidebar!
            </p>
          </Card>
        )}
