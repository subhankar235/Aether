  ...
  return (
    <aside
      ...
      className={cn(
        ...
        collapsible === 'icon' ? (open ? 'w-64' : 'w-12') : 'w-64',
        className,
      )}
    >
      {children}
...
function SidebarHeader({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div
      className={cn(
        'flex h-12 shrink-0 items-center border-b border-sidebar-border px-2 group-data-[state=collapsed]/sidebar:justify-center group-data-[state=collapsed]/sidebar:px-0',
        className,
      )}
    >
      {children}
...
function SidebarFooter({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div
      className={cn(
        'shrink-0 border-t border-sidebar-border p-3 group-data-[state=collapsed]/sidebar:p-0',
        className,
      )}
    >
      {children}
